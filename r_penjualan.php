    ...
    <table>
      ...
      <tbody>
         ...
         <tr>
            ...
            <td>
                        <?php if($row ["status"] == 0) { ?>
                            <a href="r_penjualan.php?edit=<?php echo $row['id']; ?>" class="option-btn"> KIRIM IKAN </a>
...
<section class="edit-form-container">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="hidden" class="box" required name="update_p_status" value="1">

      <input type="submit" value="KIRIM IKAN" name="update_product" class="btn">
   </form>
