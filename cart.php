...
<section class="shopping-cart">
   ...
   <h1 class="heading">KERANJANG BELANJA <?php echo $_SESSION['nama']; ?></h1>
   ...
   <table>
      ...
      <tbody>
         ...
         <tr>
            ...
            <td><?php echo $fetch_cart['nama_ikan']; ?></td>
            <td>Rp. <?php echo $fetch_cart['price']; ?> /KG</td>
            <td>
   ...
   <div class="checkout-btn">
      <a href="checkout.php" class="btn <?= ($grand_total > 1)?'':'disabled'; ?>">Pembayaran</a>
   </div>
